...
const sendVerificationEmail = async (recipientEmail, token = "", type = "default", additionParameters = {}) => {
    ...
    if (type === "resetPassword") {
        ...
        mailOptions = {
            ...
            text: `Please click the verification link below to verify your account ${verficationLink},
             Your password is ${additionParameters.password}. Please change your password.`
        }
    }
